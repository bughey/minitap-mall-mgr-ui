...
const deviceRegisterLogs = [
  // 万达广场 A区娃娃机批次的设备
  { id: 1, device_register_id: 1, device_no: 'DEV-2024-001', place_name: '万达广场', group_name: 'A区娃娃机', device_type_name: '夹娃娃机', result: 1, created_at: '2024-03-20 14:21:15' },
  { id: 2, device_register_id: 1, device_no: 'DEV-2024-002', place_name: '万达广场', group_name: 'A区娃娃机', device_type_name: '夹娃娃机', result: 1, created_at: '2024-03-20 14:21:20' },
  { id: 3, device_register_id: 1, device_no: 'DEV-2024-003', place_name: '万达广场', group_name: 'A区娃娃机', device_type_name: '夹娃娃机', result: 2, created_at: '2024-03-20 14:21:25' },
  { id: 4, device_register_id: 1, device_no: 'DEV-2024-004', place_name: '万达广场', group_name: 'A区娃娃机', device_type_name: '夹娃娃机', result: 1, created_at: '2024-03-20 14:21:30' },
  { id: 5, device_register_id: 1, device_no: 'DEV-2024-005', place_name: '万达广场', group_name: 'A区娃娃机', device_type_name: '夹娃娃机', result: 1, created_at: '2024-03-20 14:21:35' },
  { id: 6, device_register_id: 1, device_no: 'DEV-2024-006', place_name: '万达广场', group_name: 'A区娃娃机', device_type_name: '夹娃娃机', result: 1, created_at: '2024-03-20 14:21:40' },
  { id: 7, device_register_id: 1, device_no: 'DEV-2024-007', place_name: '万达广场', group_name: 'A区娃娃机', device_type_name: '夹娃娃机', result: 1, created_at: '2024-03-20 14:21:45' },
  { id: 8, device_register_id: 1, device_no: 'DEV-2024-008', place_name: '万达广场', group_name: 'A区娃娃机', device_type_name: '夹娃娃机', result: 1, created_at: '2024-03-20 14:21:50' },
  { id: 9, device_register_id: 1, device_no: 'DEV-2024-009', place_name: '万达广场', group_name: 'A区娃娃机', device_type_name: '夹娃娃机', result: 2, created_at: '2024-03-20 14:21:55' },
  { id: 10, device_register_id: 1, device_no: 'DEV-2024-010', place_name: '万达广场', group_name: 'A区娃娃机', device_type_name: '夹娃娃机', result: 2, created_at: '2024-03-20 14:22:00' },
  
  // 银泰城 B区推币机批次的设备
  { id: 11, device_register_id: 2, device_no: 'DEV-2024-011', place_name: '银泰城', group_name: 'B区推币机', device_type_name: '推币机', result: 1, created_at: '2024-03-20 13:31:00' },
  { id: 12, device_register_id: 2, device_no: 'DEV-2024-012', place_name: '银泰城', group_name: 'B区推币机', device_type_name: '推币机', result: 1, created_at: '2024-03-20 13:31:05' },
  { id: 13, device_register_id: 2, device_no: 'DEV-2024-013', place_name: '银泰城', group_name: 'B区推币机', device_type_name: '推币机', result: 2, created_at: '2024-03-20 13:31:10' },
  
  // 龙湖天街 C区夹娃娃批次的设备 (进行中)
  { id: 14, device_register_id: 3, device_no: 'DEV-2024-014', place_name: '龙湖天街', group_name: 'C区夹娃娃', device_type_name: '夹娃娃机', result: 1, created_at: '2024-03-20 15:01:00' },
  { id: 15, device_register_id: 3, device_no: 'DEV-2024-015', place_name: '龙湖天街', group_name: 'C区夹娃娃', device_type_name: '夹娃娃机', result: 1, created_at: '2024-03-20 15:01:05' },
  { id: 16, device_register_id: 3, device_no: 'DEV-2024-016', place_name: '龙湖天街', group_name: 'C区夹娃娃', device_type_name: '夹娃娃机', result: 0, created_at: '2024-03-20 15:01:10' }
]
...
function getRegisterResultBadge(result: number) {
  switch (result) {
    case 1: // 成功
      return <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">成功</span>
    case 0: // 未开始
      return <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">未开始</span>
    case 2: // 失败
      return <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800">失败</span>
    default:
      return null
...
function getBatchStatusBadge(status: number) {
  switch (status) {
    case 0: // 未开始
      return <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-800">未开始</span>
    case 1: // 进行中
      return <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">进行中</span>
    case 2: // 已结束
      return <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">已结束</span>
    case 3: // 已取消
      return <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800">已取消</span>
    default:
      return null
  }
}
...
export default function RegistrationPage() {
  ...
  // 过滤注册批次
  const filteredBatches = deviceRegisterBatches.filter(batch => 
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                onChange={(e) => setAdvancedSettings(prev => ({ ...prev, point_coin: parseInt(e.target.value) || 0 }))}
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                onChange={(e) => setAdvancedSettings(prev => ({ ...prev, coin_count: parseInt(e.target.value) || 0 }))}
                className="col-span-3"
              />
            </div>
                    ...
                    >
                      ...
                      <div className="space-y-1 text-xs text-gray-500">
                        <div className="flex justify-between">
                          <span>注册进度:</span>
                          <span className="font-medium text-green-600">{batch.count}/{batch.total}</span>
                        </div>
                      ...
                      <div className="bg-gray-50 rounded-lg p-4 mb-4">
                        ...
                        <div className="grid grid-cols-3 gap-4 text-sm">
                          <div>
                            ...
                            <p className="font-medium">{batch.place_name} - {batch.group_name}</p>
                          </div>
                          <div>
                            <span className="text-gray-600">注册进度:</span>
                            <p className="font-medium text-green-600">{batch.count}/{batch.total}</p>
                          </div>
                          <div>
