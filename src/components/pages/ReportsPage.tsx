...
import { ChartBarIcon, DocumentArrowDownIcon, PrinterIcon, ShareIcon } from '@heroicons/react/24/outline';
                    ...
                    <tr key={venue.venue}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        <span className={`${venue.today > venue.yesterday ? 'text-green-600' : 'text-red-600'}`}>
                          {venue.today > venue.yesterday ? '+' : ''}
                          {(((venue.today - venue.yesterday) / venue.yesterday) * 100).toFixed(1)}%
                        </span>
                      </td>
                    </tr>
                  ))}
